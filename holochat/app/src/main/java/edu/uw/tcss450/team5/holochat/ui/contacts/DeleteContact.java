...
//        mDeleteContractViewModel = new
//                ViewModelProvider(getActivity()).get(DeleteContactViewModel.class);
//
//
//    }
//
...
//
//        mDeleteContractViewModel.connectRemoveContact(mModel.getEmail(), mContact.getUserName(), mModel.getmJwt());
