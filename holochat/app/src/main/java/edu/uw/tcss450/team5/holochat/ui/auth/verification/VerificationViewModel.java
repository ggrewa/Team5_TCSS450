...
/*
 * Class for the Verification view model.
 *
...
public class VerificationViewModel extends AndroidViewModel {
    ...
    /** JSON response from server when user tries verification. */
    private MutableLiveData<JSONObject> mResponse;

    /**
     * Constructor the initializes the verification view model.
     *
